/*
manv * To change this license header, choose License Headers in Project Properties.
...
public class AccountFrame extends javax.swing.JFrame {
    ...
    private void btnSuaActionPerformed(java.awt.event.ActionEvent evt,String manv) throws MalformedURLException, RemoteException, NotBoundException {//GEN-FIRST:event_btnSuaActionPerformed
        // TODO add your handling code here:
    	NhanvienService nhanvienService=(NhanvienService) Naming.lookup(url);
		...
		if(yes == JOptionPane.YES_OPTION) {
			if(checkThongTin()) {
				if(nhanvienService.updateTK(nv)) {
